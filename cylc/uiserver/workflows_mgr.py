...
class WorkflowsManager:
    ...
    * Registers/connects/disconnects/unregisters workflows with the data store.
    ...
    async def _workflow_state_changes(self):
        ...
        # This can happen when the data-store registered the workflow as
        # stopped (i.e. from a shutdown delta), so self.get_workflows()
        # returns it as inactive. However, we still need to process
