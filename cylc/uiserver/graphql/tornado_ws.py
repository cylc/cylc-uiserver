...
# a condense from of the stagnant graphql-ws project:
...
from cylc.uiserver.graphql.subscribe import subscribe
...
class TornadoSubscriptionServer:
    ...
    async def send_execution_result(
        ...
        result = execution_result_to_dict(execution_result)
